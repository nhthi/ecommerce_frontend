...
const DrawerList = ({ menu, menu2, toggleDrawer }: DrawerListProps) => {
  ...
  return (
    <div className="h-full">
      <div className="flex h-full w-[300px] flex-col justify-between border-r border-orange-500/12 bg-[radial-gradient(circle_at_top,_rgba(249,115,22,0.12),_transparent_26%),linear-gradient(180deg,_#151515_0%,_#0c0c0c_100%)] px-4 py-5 text-white shadow-[0_20px_60px_rgba(0,0,0,0.28)]">
        <div>
          <div className="mb-5 rounded-[1.4rem] border border-orange-500/12 bg-white/[0.03] px-4 py-4">
            ...
            <p className="mt-1 text-sm leading-6 text-neutral-400">
              Quan ly san pham, don hang, seller va van hanh he thong.
            </p>
          </div>
