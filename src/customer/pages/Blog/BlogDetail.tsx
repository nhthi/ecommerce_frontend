          ...
          <>
            ...
            >
              ...
              <Box sx={{ p: { xs: 2.5, md: 4 } }}>
                ...
                <Typography sx={{ mt: 1.5, color: "rgba(255,255,255,0.74)", fontSize: 17, lineHeight: 1.8 }}>
                  ...
                  <Stack direction="row" spacing={1} flexWrap="wrap" useFlexGap sx={{ mt: 2.2 }}>
                    {post.tags.map((tag) => (
                      <Chip
                        key={tag.id}
                        label={`#${tag.name}`}
                        sx={{ color: "#fff7ed", backgroundColor: "rgba(255,255,255,0.05)" }}
                      />
                    ))}
                  </Stack>
                )}
                ...
                >
                  ...
                  >
                    <Box>
                      ...
                      <Typography sx={{ mt: 0.7, color: "rgba(255,255,255,0.7)", fontSize: 14.5 }}>
                  ...
                  {summaryRequested && (
                    ...
                    >
                      ...
                      <Typography sx={{ mt: 0.8, color: "rgba(255,255,255,0.74)", fontSize: 14.8, lineHeight: 1.75 }}>
                        {buildSummary(post)}
                      </Typography>
                    </Paper>
                  )}
                ...
                <Stack spacing={1.4} sx={{ mt: 1.6 }}>
                  {relatedPosts.map((item) => (
                    ...
                    >
                      ...
                      <Typography sx={{ mt: 0.8, color: "rgba(255,255,255,0.7)", fontSize: 14.5 }}>
