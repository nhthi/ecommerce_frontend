      ...
      <div className="mx-auto max-w-[1280px]">
        <div className="mb-8 max-w-2xl">
          ...
          <h2 className="mt-2 text-3xl font-black text-white md:text-4xl">
            Các thương hiệu và dòng sản phẩm đang được quan tâm
          </h2>
        </div>
        ...
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
          {brands.map((brand, i) => (
            <motion.button
              ...
              whileHover={{ y: -4 }}
              className="overflow-hidden rounded-[1.75rem] border border-orange-500/15 bg-white/[0.03] text-left transition hover:border-orange-400/35"
