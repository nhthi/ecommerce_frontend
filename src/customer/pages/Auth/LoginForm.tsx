    ...
    <div className="w-full flex justify-center items-center py-8">
      ...
      <div className="w-full max-w-md bg-white/90 dark:bg-slate-900/90 rounded-2xl shadow-2xl border border-slate-100 dark:border-slate-800 p-8 backdrop-blur-md transition-all duration-300 hover:shadow-[0_20px_45px_rgba(0,0,0,0.25)] hover:-translate-y-1">
        <div className="flex flex-col items-center gap-2 mb-6">
          <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-sky-500 to-indigo-500 flex items-center justify-center shadow-lg mb-1">
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400 text-center">
            Nhập email của bạn để nhận mã OTP đăng nhập an toàn.
          </p>
        </div>
        ...
        <div className="space-y-5">
          ...
          {sendOtp ? (
            <Button
              ...
              sx={{
                ...
                boxShadow: "0 18px 35px rgba(59,130,246,0.45)",
                "&:hover": {
                  background:
          ...
          {!sendOtp && (
            <p className="text-xs text-center text-slate-400">
              Chúng tôi sẽ gửi một mã xác thực dùng một lần đến email của bạn.
            </p>
          )}
        </div>
      </div>
